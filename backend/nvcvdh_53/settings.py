"""
Django settings for nvcvdh_53 project.
...
WSGI_APPLICATION = 'nvcvdh_53.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nvcvdh_53 API",
    "DESCRIPTION": "API documentation for nvcvdh_53 App",
    "VERSION": "v1",
}
